  ...
  <table id="data-table" class="display table table-striped" cellspacing="0" width="100%">
    ...
    @foreach($buyers as $buyer)
      <tr>
        ...
        <td>{{ $buyer->order->items->first()->title }}</td>
        ...
        <td style="text-align: center" class="actions">
          ...
          &nbsp;&nbsp;&nbsp;<a data-toggle="modal" data-target="#form-modal" href="{{ route('invoice.edit', $buyer->order->invoice->id) }}" class="edit" style="color: #E22919" title="{{ $buyer->title }}"><i class="fa fa-pencil"></i></a>
        </td>
      </tr>
    @endforeach
    </tbody>
