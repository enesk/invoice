      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li>{!! link_to_route('ebay', 'Alle Aufträge') !!}</li>
            <li>
              <a data-toggle="modal" data-target="#form-modal" href="{{ route('invoice.create') }}">Auftrag
                erstellen</a>
            </li>
            <li>{!! link_to_route('ebay.save', 'Neue Aufträge speichern') !!}</li>
          </ul>
        </li>
      </ul>
